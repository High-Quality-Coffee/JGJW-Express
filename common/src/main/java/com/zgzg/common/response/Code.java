...
public enum Code {
   ...
   *  Ai & Slack 7000번대
   */
  SLACK_SUCCESS(HttpStatus.OK, 7001, "슬랙 메세지 전송이 완료되었습니다."),
  GEMINI_VERIFY_SUCCESS(HttpStatus.OK, 7002, "메세지 검증이 완료되었습니다."),

  SLACK_SEND_FAIL(HttpStatus.INTERNAL_SERVER_ERROR,7101,"메세지 전송에 실패했습니다."),
